...
def find_components(chords):
    ...
    for chord in chords:
        ...
        # root_number, semitone_bitmap, bass_number = mir_eval.chord.encode(chord)
        # abs_quality_bmap = mir_eval.chord.rotate_bitmap_to_root(quality_bmap, root_number)
        # print(root, root_number, semitone_bitmap, bass_number, quality, quality_bmap, abs_quality_bmap)
